    ...
    >
      ...
      >
        <div className="rounded-2xl md:w-2/3 text-glass shadow-[#aea5a2] dark:shadow-[#020010] dark:bg-[#111928bf] bg-[#f2f3f4] p-4 md:m-3 m-1 shadow-2xl">
          <h2 className="about-name text-center text-style text-name text-3xl font-bold py-6">
            Priya Dharshini Ashok
          </h2>
          <div className="dark:text-white text-black font-semibold py-6">
            <h3 className="">
              I'm a Computer Science Engineering student specializing in Cybersecurity at Amrita Vishwa Vidyapeetham, Chennai, India.
            </h3>
            <br />
            <h3 className="">
              I'm passionate about developing secure and scalable applications, combining my expertise in full-stack development with a strong foundation in cybersecurity principles. I've developed various projects focusing on blockchain, AI, and healthcare technologies.
            </h3>
            <br />
            <h3 className="pb-1">
              My technical skills include Java, Python, JavaScript, ReactJS, and experience with databases like MySQL and MongoDB. I'm also actively involved in the AMC Free Open Source Software (FOSS) Club as a Coordinator, where I lead and mentor students in web development projects.
            </h3>
          </div>
        </div>
